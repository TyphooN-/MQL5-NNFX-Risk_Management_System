               ...
               const int&      spread[])
{
   ...
   datetime endTime = time[rates_total - 1];
    ...
    #endif
#endif
   if (D1_ATR_Projections && _Period <= PERIOD_W1 && _Period != PERIOD_MN1 && avgD1 > 0 && g_startTimeD1 > 0 && currentOpenD1 > 0)
   {
   ...
   if (W1_ATR_Projections && avgW1 > 0 && g_startTimeW1 > 0 && currentOpenW1 > 0)
   {
   ...
   if (MN1_ATR_Projections && avgMN1 > 0 && g_startTimeMN1 > 0 && currentOpenMN1 > 0)
   {
   ...
   if (H4_ATR_Projections && _Period <= PERIOD_D1 && _Period != PERIOD_MN1 && avgH4 > 0 && g_startTimeH4 > 0 && currentOpenH4 > 0)
   {
   ...
   if (H1_ATR_Projections && _Period <= PERIOD_H4 && _Period != PERIOD_MN1 && avgH1 > 0 && g_startTimeH1 > 0 && currentOpenH1 > 0)
   {
   ...
   if (M15_ATR_Projections && _Period <= PERIOD_H1 && _Period != PERIOD_MN1 && avgM15 > 0 && g_startTimeM15 > 0 && currentOpenM15 > 0)
   {
